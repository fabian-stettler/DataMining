...
initialCommandVpnConnection="sudo openvpn --config /etc/openvpn/$currentVpnConnection --auth-user-pass /home/supremeleader/Documents/DataMiningProjekt/userpass.txt"
...
# Check the exit status of the OpenVPN command
if [ $? -eq 0 ]; then
